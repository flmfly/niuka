...
public class Test2 {
	...
	public static void main(String[] args) {
		...
		Mat src = imread("/Users/Jeffrey/IMG_7643.JPG");
...
//			Mat grayMat = imread("/Users/Jeffrey/IMG_6761_aha.JPG", CV_LOAD_IMAGE_GRAYSCALE);
//
//			int thresh = 180;
//			
//			threshold(grayMat, grayMat, thresh, 255, THRESH_BINARY);
//			erode(grayMat, grayMat, getStructuringElement(CV_SHAPE_RECT, new Size(2, 2)));
//			dilate(grayMat, grayMat, getStructuringElement(CV_SHAPE_RECT, new Size(2, 2)));
//			
